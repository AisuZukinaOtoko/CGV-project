...
const zombieSounds = {
  idle: new Audio("./Sounds/zombie_idle.mp3"),
  walking: new Audio("./Sounds/zombie_idle.mp3"),
  aggravated: new Audio("./Sounds/zombie_idle.mp3"),
  attack: new Audio("./Sounds/zombie_attack.mp3"),

  injured: new Audio("./Sounds/zombie_idle.mp3"),
  startled: new Audio("./Sounds/zombie_idle.mp3"),
  death: new Audio("./Sounds/zombie_die.mp3"),
};
...
export class AttackState extends State {
  ...
  execute(zombie) {
    ...
    if (progress > 0.5 && canAttack && !zombie.attackCooldown) {
      // Time of attack
